...
public class playercontrollerPretre : MonoBehaviour
{
    ...
    private void BasicMovement()
    {
        ...
        if (Time.time > nextcast4)
        {
            if (Input.GetKey(KeyCode.F))
            {
                MyPlayerAnimator.SetInteger("Attack", 4);
                nextcast4 = Time.time + CooldownTime4;
            }
        }
    }
